...
const Subscribe = () => {
    return (
      <div className=" rounded-2xl shadow-2xl text-center w-1/2 mx-auto p-10  mt-5 mb-5 bg-wh-10 hidden md:block">
        ...
        />
        <Button className="   text-wh-10 font-semibold w-5/6 min-w-[100px] px-5 py-2 mt-3">
          הירשם
        </Button>
      </div>
    );
